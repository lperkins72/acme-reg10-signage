...
This folder is the region-default content layer for `reg10`.
...
- `regions/reg10/data/primary-assets.json`
- `regions/reg10/data/primary.json`
- `regions/reg10/data/footer.json`
- `regions/reg10/data/primaryending.json`
- `regions/reg10/assets/primary/manifest.json`
- `regions/reg10/assets/footer/manifest.json`
...
Use this folder for region-wide defaults that should affect `reg10`.
